...
import excel "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Michael Taylor\Excel Files, .dta Files\LTDL_NV_Seeding_Trt_List_10-20-2016.xlsx", sheet("LTDL & Beth (Me
> rged)") firstrow
drop _merge
duplicates list
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\LTDL & Beth (Merged & Refined).dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\LTDL & Beth (Merged & Refined).dta saved
clear
...
import excel "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Michael Taylor\Excel Files, .dta Files\LTDL_NV_Seeding_Trt_List_10-20-2016.xlsx", sheet("Seeded Species"
> ) firstrow

**SAVED MASTER DATASET AS "LTDL (Seeded Species).dta"
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\LTDL (Seeded Species).dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\LTDL (Seeded Species).dta saved

**m:1 MERGE 'MASTER DATASET' "LTDL (Seeded Species).dta" WITH 'USING DATASET' "LTDL & Beth (Merged & Refined).dta" 
merge m:1 Species using "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\LTDL & Beth (Merged & Refined).dta"
drop _merge

**SAVED MERGED DATASET AS "Final Merged Dataset.dta"
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset.dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset.dta saved
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset.dta", replace
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset.dta saved
clear
*********************************************************************************************************************************************************************
...
import excel "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Michael Taylor\Excel Files, .dta Files\LTDL_NV_Seeding_Trt_List_10-20-2016.xlsx", sheet("Treatment Infor
> mation") firstrow

**SAVED AS "Treatment Information.dta"
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Treatment Information.dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Treatment Information.dta saved

clear

**m:1 merge between "FINAL MERGED DATASET.DTA" & "TREATMENT INFORMATION" WORKSHEET IN 'LTDL_NV_Seeding_Trt_List_10-20-2016.xls'
use "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset.dta", clear
merge m:1 Treatment_ID using "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Treatment Information.dta"
drop _merge

**SAVED THE MERGED WORKSHEET AS "Final Merged Dataset & Treatment Information (Merged).dta"
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (Merged).dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (Merged).dta saved
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (Merged).dta", replace
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (Merged).dta saved
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (Merged & Updated).dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (Merged & Updated).dta saved
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U1).dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U1).dta saved
...
> du\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U1).xls", firstrow(variables)
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U1).xls saved
...
**06/28/2018
import excel "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U1).xls", sheet("Sheet1") firstrow
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U1).dta", replace
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U1).dta saved
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U2).dta"
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U2).dta saved
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\07.02.2018\Final Merged Dataset & Treatment Information (M&U2).dta", replace
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\07.02.2018\Final Merged Dataset & Treatment Information (M&U2).dta saved
...
save "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U2).dta", replace
file \\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\Prof. Taylor 2\Final Merged Dataset & Treatment Information (M&U2).dta saved
...
merge m:1 Standardized_Common_Year using "\\bfs.coba.unr.edu\gradhome\sourikb\Desktop\Studies\07.02.2018\UDWR (Top 4
